...
int main(int argc, char *argv[])
{
    ...
    while ((tunnel = get_tunnel("8000", "test")) != -1) {
        ...
        ////if((res = pthread_create(t_id, NULL, read_send, (void *) &connection)) != 0)handle_error_en(res, "pthread_create");
        
        //if((res = pthread_create(t_id + 1, NULL, recv_write, (void *) &connection)) != 0)handle_error_en(res, "pthread_create");
